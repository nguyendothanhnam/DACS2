            ...
            <tbody>
                @if (Session::has('cart') != null)
                    ...
                    @foreach (Session::get('cart') as $key => $cart)
                        ...
                        <tr>
                            ...
                            <button class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Xóa</button>
                                ...
                                <a class="cart_quantity_delete" href="{{ URL::to('/del-product/' . $cart['session_id']) }}"><i
                    ...
                    <tr style="border-style: none">
                        <td>
                            <button name="update_qty" onclick="submitCartForm()" class="btn btn-primary check_out">Cập nhật giỏ hàng</button>
